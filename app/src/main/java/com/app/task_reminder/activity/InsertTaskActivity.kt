...
class InsertTaskActivity : BaseBindingActivity<ActivityTaskBinding>() {
    ...
    override fun getActivityContext(): BaseActivity {
        return this@InsertTaskActivity
    }
    ...
    override fun initView() {
        ...
        with(mBinding) {
            txtMainTitle.text = resources.getString(R.string.add_task)
            txtSave.text = resources.getString(R.string.add)
            ...
            txtSave.setOnClickListener {
                ...
                if (title.isEmpty())
                    ...
                    toastMsg(getString(R.string.task_saved_successfully))
                    finish()
                }
            }
        }
